...
- (MWScrubViewAttribute*)scrubView:(MWScrubView *)scrubView attributeForItemAtIndexPath:(NSIndexPath *)indexPath {
  NSAttributedString *attributedString = indexPath.item % 5 == 0 ? [[NSAttributedString alloc] initWithString:[self.sections[indexPath.section][indexPath.item] stringValue]] : nil;
  NSUInteger weight = indexPath.item % 5 == 0 ? 20 : 1;
  return [MWScrubViewAttribute attributeWithAttributedText:attributedString weight:weight];
}
